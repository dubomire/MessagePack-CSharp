...
namespace SharedData
{
    ...
    public class DynamicArgumentTupleFormatter<T1, T2, T3, T4, T5, T6, T7, T8, T9> : IMessagePackFormatter<DynamicArgumentTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9>>
    {
        ...
        public int Serialize(TargetBuffer target, DynamicArgumentTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> value, IFormatterResolver formatterResolver)
        {
            MessagePackBinary.WriteFixedArrayHeaderUnsafe(target, 9);
            ...
            formatterResolver.GetFormatterWithVerify<T8>().Serialize(target, value.Item8, formatterResolver);
            formatterResolver.GetFormatterWithVerify<T9>().Serialize(target, value.Item9, formatterResolver);
            return 0;
        }
